...
class LandownerDashboard extends StatefulWidget {
  ...
  const LandownerDashboard({super.key, required this.role});
...
class _LandownerDashboardState extends State<LandownerDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(AppLocale.get('My Parcel')),
        ...
        child: Column(
          ...
          children: [
            ...
            _statCard(
              ...
              value: '58 / 100',
              subtitle: AppLocale.get('Health Score'),
              color: Colors.green,
            ),
            ...
            _statCard(
              ...
              value: '~2.3 acres',
              subtitle: AppLocale.get('Parcel Area'),
              color: Colors.teal,
            ),
            const SizedBox(height: 20),
            Text(AppLocale.get('AI Modules'),
                style:
            ...
            _menuTile(
              ...
              onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => ParcelMapScreen(role: widget.role))),
            ),
            _menuTile(
              context,
              ...
              onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => LandHealthScreen(role: widget.role))),
            ),
            _menuTile(
              context,
              icon: Icons.grass,
              ...
              onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => PlantZoneScreen(role: widget.role))),
            ),
            if (widget.role == 'consultant')
              _menuTile(
                ...
                subtitle:
                    AppLocale.get('Value estimate - Price bands - Factors'),
                color: Colors.amber,
                onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) =>
                            LandValuationScreen(role: widget.role))),
              ),
          ],
        ),
      ),
